...
########################################################################
### Variable required to perform the mqtt ec2 failover
########################################################################

variable "instance_action_name" {
  description = "Name of the action to be performed for the aurora ec2 failover"
  type        = string
}

variable "instance_action_id" {
  description = "Id of the action for the mqtt failover"
  type        = string
}

variable "instance_target_key" {
  description = "target key for the mqtt failover"
  type        = string
}

variable "instance_target_name" {
  description = "target name for the mqtt failover"
  type        = string
}

variable "instance_resource_type" {
  description = "instance resource type for the mqtt failover"
  type        = string
}
...
variable "instance_resource_arns" {
  description = "Return the ec2 instances role arn"
  type        = set(string)
}
